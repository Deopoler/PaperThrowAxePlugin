...
dependencies {
    ...
    implementation("io.github.monun:heartbeat-coroutines:${Dependency.HeartBeatCoroutines.Version}")
...
extra.apply {
    ...
    set("heartBeatCoroutinesVersion", Dependency.HeartBeatCoroutines.Version)
}
